...
function RegisterContent() {
  ...
  // Supabase для Magic Link регистрации
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (!name.trim()) {
      setMessage({ type: 'error', text: 'Introduceți numele' })
      return
    }
            ...
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <label htmlFor="marketing" className="text-sm text-gray-700">
                    Accept să primesc comunicări de marketing și oferte speciale
                  </label>
                </div>
              </div>
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    <span>Trimite link-ul de înregistrare</span>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <ul className="space-y-1 text-blue-700">
                    <li>• Introduceți numele și email-ul</li>
                    <li>• Acceptați termenii și condițiile</li>
                    <li>• Verificați inbox-ul și spam-ul</li>
                    <li>• Faceți click pe link-ul din email</li>
                    <li>• Contul dvs. va fi creat automat</li>
                  </ul>
                </div>
              </div>
            </div>
