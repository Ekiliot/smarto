                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-8">
                  ...
                  <div className="space-y-3">
                    <button
                      ...
                      className="w-full px-6 py-3 bg-orange-500 text-white rounded-lg font-medium hover:bg-orange-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 text-sm"
                    >
                      <CreditCard className="w-4 h-4" />
                      <span className="whitespace-nowrap">Finalizează comanda ({getSelectedItemsCount()})</span>
                    </button>
          ...
          <div className="px-4 py-3">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={handleCheckout}
                disabled={getSelectedItemsCount() === 0}
                className="px-4 py-2 bg-orange-500 text-white rounded-lg font-medium hover:bg-orange-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm whitespace-nowrap"
              >
